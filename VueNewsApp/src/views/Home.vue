...
<main v-if="!loading">
    ...
    <div class="footer">
      <h2 class="credits">Made with <span class="heartbeat">❤️</span> by Selemon Brahanu</h2>
    </div>
</main>
<main v-else>
...
export default {
    ...
    methods: {
        ...
        const response = await fetch(`https://newsapi.org/v2/top-headlines?country=us&pageSize=100&apiKey=${API_KEY}`);
